...
import com.example.awaq_agromo.presentation.screens.diagnostico.DiagnosticoScreen
import com.example.awaq_agromo.presentation.screens.finalizacion.RegistroExitosoScreen
...
import com.example.awaq_agromo.presentation.screens.manejo_aplicado.FertilizacionScreen
...
fun AppNavigation(navController: NavHostController) {
    NavHost(navController = navController, startDestination = "welcome") {
        ...
        composable("registration") {
            RegistrationScreen(onOnboardingClick = { navController.navigate("Onboarding_1") })
        }
        ...
        composable("fertilizacion") {
            FertilizacionScreen(navController)
        }
